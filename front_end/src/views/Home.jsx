...
const Home = () => {
  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-12 sm:px-6 lg:px-8">
    ...
    <div class="container px-6 py-8 mx-auto">
        <h1 class="text-2xl font-semibold text-center  capitalize lg:text-3xl ">Pricing Plan</h1>
    ...
    <div class="container px-6 py-10 md:px-24 mx-auto">
        <div class="lg:flex lg:items-center">
            <div class="w-full space-y-12 lg:w-1/2 ">
                <div>
                    <h1 class="text-2xl font-semibold  capitalize lg:text-3xl ">Sourcing, Producing and Exporting <br/>single Origin Coffee</h1>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    <span class="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4  bg-blue-500">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize ">Honest Dealings</h1>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize ">Mutually Beneficial</h1>
                ...
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-xl font-semibold text-gray-700 capitalize ">Life Enhancement</h1>
