...
import buna2 from '../assets/buna2.jpg'
import buna3 from '../assets/buna3.jpg'
        ...
        <div className="mx-auto max-w-2xl py-32 ">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
             The First Ethiopan Online Coffee Market
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
                The home to all your coffee cravings.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                to="/shop"
                className="rounded-md bg-[#B76615] px-3.5 py-2.5 text-sm font-semibold  shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
               Shop Now
              </Link>
              <Link to="/about" className="text-sm font-semibold leading-6 text-gray-900 hover:text-red-500">
        ...
        <Link to='/shop' key={product.id}  className="group relative">
          <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
            ...
            <div className="absolute bottom-0 left-0 p-4">
              <h3 className="text-2xl text-blue-500 font-bold">{product.name}</h3>
    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
      <div className="grid p-6 bg-gray-100 rounded place-content-center sm:p-8">
        <div className="max-w-md mx-auto text-center lg:text-left">
          <header>
            <h2 className="text-xl font-bold text-gray-900 sm:text-3xl">Coffee</h2>
...
– Earl Wilson
          ...
          <Link
            to="/shop"
            className="inline-block px-12 py-3 mt-8 text-sm font-medium  transition border border-gray-900 rounded hover:shadow focus:outline-none focus:ring"
          >
            Shop All
          </Link>
        </div>
              ...
              {users.slice(0, 2).map(product => (
                <Link to={`/shop/${product.product.id}`} className="group relative block overflow-hidden" key={product.product.id}>
                  ...
                  <div className="relative border border-gray-100 bg-white p-6">
                    ...
                    <p className="mt-1.5 text-sm text-gray-700">${product.product.price}</p>
    ...
    <div className="container px-6 py-8 mx-auto">
        <h1 className="text-2xl font-semibold text-center  capitalize lg:text-3xl ">Pricing Plan</h1>

        <p className="max-w-2xl mx-auto mt-4 text-center  xl:mt-6 ">
        How do you want set your subscription pricing? 
        </p>

        <div className="grid grid-cols-1 gap-8 mt-6 xl:mt-12 xl:gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="w-full p-8 space-y-8 text-center border border-gray-200 rounded-lg border-gray-700">
                <p className="font-medium  uppercase ">Basic</p>

                <h2 className="text-4xl font-semibold  uppercase ">
                   ETB 1000
                </h2>

                <p className="font-medium ">Post Upto 15 Posts</p>

                <button   onClick={handleStart} className="w-full px-4 py-2 mt-10 tracking-wide  capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                    Start Now
                </button>
            </div>
            ...
            <div className="w-full p-8 space-y-8 text-center bg-blue-600 rounded-lg">
                ...
                <p className="font-medium text-gray-200">Can Post Upto 20 Posts</p>

                <button   onClick={handleStart} className="w-full px-4 py-2 mt-10 tracking-wide text-blue-500 capitalize transition-colors duration-300 transform bg-white rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:ring focus:ring-gray-200 focus:ring-opacity-80">
                    Start Now
                </button>
            </div>

            <div className="w-full p-8 space-y-8 text-center border border-gray-200 rounded-lg border-gray-700">
                <p className="font-medium  uppercase ">Enterprise</p>

                <h2 className="text-4xl font-semibold  uppercase ">
                    2000
                </h2>

                <p className="font-medium ">Can post upto 25 posts</p>
    ...
    <div className="container px-6 py-10 md:px-24 mx-auto">
        <div className="lg:flex lg:items-center">
            <div className="w-full space-y-12 lg:w-1/2 ">
                <div>
                    <h1 className="text-2xl font-semibold  capitalize lg:text-3xl ">Sourcing, Producing and Exporting <br/>single Origin Coffee</h1>
                ...
                <div className="md:flex md:items-start md:-mx-4">
                    <span className="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4  bg-blue-500">
                    ...
                    <div className="mt-4 md:mx-4 md:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize ">Honest Dealings</h1>
                ...
                <div className="md:flex md:items-start md:-mx-4">
                    ...
                    <div className="mt-4 md:mx-4 md:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize ">Mutually Beneficial</h1>
                ...
                <div className="md:flex md:items-start md:-mx-4">
                    ...
                    <div className="mt-4 md:mx-4 md:mt-0">
                        <h1 className="text-xl font-semibold text-gray-700 capitalize ">Life Enhancement</h1>
