  ...
  return (
    <>
      <section className="bg-white">
        <nav className="relative px-4 mx-4 md:mx-8  flex justify-between items-center">
          ...
          <a
            className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold
